...
const ALL: Tier[] = ["leadership", "zone_leader", "hr", "leader", "recruiter", "teammate", "partner"];
...
const NAV: NavItem[] = [
  ...
  { to: "/console",     label: "Operator Console", icon: Zap,             tiers: ["leadership","zone_leader","hr","leader","recruiter"] },
  ...
  { to: "/one-on-ones", label: "1:1 Notes",        icon: MessageSquareText, tiers: ["leadership","zone_leader","hr","leader","recruiter"] },
  { to: "/people",      label: "People",           icon: Users,           tiers: ["leadership","zone_leader","hr","leader"] },
  { to: "/roster",      label: "Live Roster",      icon: ClipboardList,   tiers: ["leadership","zone_leader","hr","leader"] },
  { to: "/war-room",    label: "War Room",         icon: Activity,        tiers: ["leadership","zone_leader","leader"] },
  { to: "/command",     label: "Coaching",         icon: MessageSquare,   tiers: ["leadership","zone_leader","hr","leader"] },
...
export function AppShell() {
  ...
  const mobileNav =
    tier === "partner"
      ? [MOBILE_NAV_BASE[0], { to: "/partner", label: "Properties", icon: Building2 }, { to: "/partner", label: "Payouts", icon: Wallet }, MOBILE_NAV_BASE[3], MOBILE_NAV_BASE[4]]
      : tier === "zone_leader"
      ? [MOBILE_NAV_BASE[0], { to: "/zones", label: "Zone", icon: MapIcon }, { to: "/fly", label: "Fly", icon: PlaneTakeoff }, MOBILE_NAV_BASE[3], MOBILE_NAV_BASE[4]]
    ...
    <aside className="w-60 shrink-0 bg-sidebar text-sidebar-foreground border-r border-sidebar-border flex flex-col h-full">
      <div className="px-5 py-4 border-b border-sidebar-border flex items-center gap-2">
        <button onClick={() => navigate({ to: "/" })} className="flex items-center gap-2 flex-1 text-left">
          ...
          <div>
            <div className="font-display font-semibold text-white text-sm tracking-[0.18em]">GHARPAYY</div>
            <div className="font-mono text-[10px] uppercase tracking-widest text-sidebar-foreground/70">Core Arena · v2026</div>
          </div>
        </button>
      ...
      <div className="px-3 py-3 border-b border-sidebar-border">
        <div className="text-[10px] uppercase tracking-widest font-mono text-sidebar-foreground/60 mb-1.5 px-1">Signed in</div>
        <div className="px-1">
