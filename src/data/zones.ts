...
export const PARTNER_TICKETS: PartnerTicket[] = [
  { id: "tk1", propertyId: "p2", openedBy: "e10", title: "WiFi flaky in Block B", category: "Maintenance", status: "In Progress", priority: "High", ts: now - 2 * D, assigneeId: "e4", lastUpdate: "Vendor visit booked for tomorrow 11 AM." },
  { id: "tk2", propertyId: "p10", openedBy: "e30", title: "Geyser dead — Room 304", category: "Maintenance", status: "Open", priority: "Med", ts: now - 1 * D, lastUpdate: "Awaiting plumber slot." },
  { id: "tk3", propertyId: "p1", openedBy: "e10", title: "May payout reconciliation", category: "Billing", status: "Resolved", priority: "Low", ts: now - 6 * D, assigneeId: "e1", lastUpdate: "Resolved — paid ₹8.4L on 12th." },
  { id: "tk4", propertyId: "p8", openedBy: "e10", title: "Fire safety NOC renewal", category: "Compliance", status: "Open", priority: "High", ts: now - 3 * D, lastUpdate: "Documents collected, application drafting." },
  { id: "tk5", propertyId: "p11", openedBy: "e10", title: "Tenant dispute — refund request", category: "Tenant", status: "In Progress", priority: "Med", ts: now - 4 * D, assigneeId: "e8" },
];

export const PARTNER_PAYOUTS: PartnerPayout[] = [
  { id: "py1", partnerId: "e10", propertyId: "p1", month: "Apr 2026", gross: 928000, deductions: 92800, net: 835200, status: "Paid", paidAt: now - 12 * D },
  { id: "py2", partnerId: "e10", propertyId: "p2", month: "Apr 2026", gross: 624000, deductions: 62400, net: 561600, status: "Paid", paidAt: now - 12 * D },
  { id: "py3", partnerId: "e10", propertyId: "p8", month: "Apr 2026", gross: 660000, deductions: 66000, net: 594000, status: "Paid", paidAt: now - 12 * D },
  { id: "py4", partnerId: "e10", propertyId: "p9", month: "Apr 2026", gross: 510000, deductions: 51000, net: 459000, status: "Paid", paidAt: now - 12 * D },
  { id: "py5", partnerId: "e10", propertyId: "p1", month: "May 2026", gross: 928000, deductions: 92800, net: 835200, status: "Scheduled" },
  { id: "py6", partnerId: "e10", propertyId: "p2", month: "May 2026", gross: 624000, deductions: 62400, net: 561600, status: "Scheduled" },
  { id: "py7", partnerId: "e10", propertyId: "p8", month: "May 2026", gross: 660000, deductions: 0,     net: 660000, status: "On Hold" },
  { id: "py8", partnerId: "e30", propertyId: "p3", month: "Apr 2026", gross: 578000, deductions: 57800, net: 520200, status: "Paid", paidAt: now - 12 * D },
  { id: "py9", partnerId: "e30", propertyId: "p5", month: "Apr 2026", gross: 799000, deductions: 79900, net: 719100, status: "Paid", paidAt: now - 12 * D },
];
